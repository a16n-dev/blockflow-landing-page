        ...
        <div className={'flex flex-col gap-4 col-span-5'}>
          ...
          >
            <div className={'flex gap-2 items-center text-theme-main pb-2'}>
              ...
              <div className={'font-bold font-theme-display'}>Recent Notes</div>
            </div>
            <div
              className={
          ...
          <div className={'grid grid-cols-2 gap-4 h-0 grow overflow-hidden'}>
            <div className={'p-4 flex flex-col'}>
              ...
              >
                ...
                <br />
                <span className={'opacity-50 text-xs'}>{'- Oscar Wilde'}</span>
              </div>
            </div>
          ...
          >
            <div className={'relative left-8 -top-6 rotate-2'}>
              ...
              <img
                src={'/imgBlock.jpg'}
                alt={'imgBlock'}
                className={'aspect-video bg-theme-main-bg rounded-lg shadow-lg'}
              />
            </div>
          </div>
          <div>
